...
CREATE TABLE equipementClient(
   numEquipement INTEGER AUTOINCREMENT,
...
CREATE TABLE bilan(
   numBilan INTEGER AUTOINCREMENT,
...
CREATE TABLE simulationClient(
   numSimulation INTEGER AUTOINCREMENT,
